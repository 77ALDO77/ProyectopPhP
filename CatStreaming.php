    ...
    <body>
        ...
        <div class="productContainer">
            ...
            <script type="text/javascript">
                ...
                <?php 
                    $sqlST="select Imagen from Productos where idCategoriaN2=5;";
                ...
                <?php 
                    $sqlST="select id from Productos where idCategoriaN2=5;";
                    $result= mysqli_query($cn,$sqlST);
                    $Productos=[];
                    while($fila= mysqli_fetch_assoc($result)){  
                        $ids[]= $fila["id"];
                ...
                <?php 
                    $sqlST="select Nombre from Productos where idCategoriaN2=5;";
                    $result= mysqli_query($cn,$sqlST);
                    $Productos=[];
                    while($fila= mysqli_fetch_assoc($result)){  
                        $nombres[]= $fila["Nombre"];
                ...
                <?php 
                    $sqlST="select Precio from Productos where idCategoriaN2=5;";
                    $result= mysqli_query($cn,$sqlST);
                    $Productos=[];
                    while($fila= mysqli_fetch_assoc($result)){  
                        $precios[]= $fila["Precio"];
